    ...
    public partial class AddIdentitySystem : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "admin-role-id", null, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "관리자 역할", "Admin", "ADMIN" },
                    { "user-role-id", null, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "일반 사용자 역할", "User", "USER" }
                });
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Boards_AspNetUsers_AuthorId",
                table: "Boards",
                column: "AuthorId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
