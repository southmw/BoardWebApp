...
{
    /// <inheritdoc />
    public partial class AddBoardAttachments : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoardAttachments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BoardAttachments_Boards_BoardId",
                        column: x => x.BoardId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoardAttachments_BoardId",
